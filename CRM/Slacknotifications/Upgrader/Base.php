 ...
 */
class CRM_Slacknotifications_Upgrader_Base {

  /**
   * @var CRM_Slacknotifications_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Slacknotifications_Upgrader(
        'com.chrishardie.slacknotifications',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Slacknotifications_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Slacknotifications_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
